...
<link rel="stylesheet" href="{root}assets/css/landing.css?v=70">
  ...
  <div class="wrap">
    <div class="foot-grid">
      <div class="foot-brand">
        <img class="foot-logo" src="{root}assets/img/new-abi-logo.jpg" alt="American Barber Institute" width="385" height="99">
