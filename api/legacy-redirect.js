...
module.exports = (req, res) => {
  ...
  // Only "es" is a real prefix here -- an existing redirect already
  // normalizes "/spanish/*" to "/es/*" before any request reaches this
  // function, so recognizing "spanish" too would be dead weight.
  let langPrefix = "";
  let rest = segments;
  if (segments[0] === "es") {
